...
export const E_ERROR = {
  WRONG_EMAIL_OR_PASsWORD    : { message: 'Wrong email / password', status: HTTP_CODE.UNAUTHORIZED },
  ...
  EMAIL_AND_PASSWORD_REQUIRED: { message: 'E-mail and password is required', status: HTTP_CODE.BAD_REQUEST },
  ...
  NO_PERIOD_SPECIFIED        : { message: 'No Period is found or Period is not provided', status: HTTP_CODE.BAD_REQUEST }
} as const
